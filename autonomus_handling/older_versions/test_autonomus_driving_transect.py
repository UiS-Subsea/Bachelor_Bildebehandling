...
class Test_autonomus_transect_manuver(unittest.TestCase):
    def test_go_forward(self):
        manuver_command = autonomus_transect_manuver("autonomus_handling/older_versions/transect_straight.png")
    ...
    def test_go_left(self):
        manuver_command = autonomus_transect_manuver("autonomus_handling/older_versions/transect_to_left.png")
        self.assertEqual(manuver_command[0], "SWING LEFT")
        self.assertLessEqual(manuver_command[1], -1)

    def test_go_right(self):
        manuver_command = autonomus_transect_manuver("autonomus_handling/older_versions/transect_to_right.png")
