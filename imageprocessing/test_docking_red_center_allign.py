...
class Test_docking_red_center_allign(unittest.TestCase):
    def test_move_forward(self):
        dock_command = docking_red_center_allign("images\move_forward_720.png")
        self.assertEqual(dock_command, "MOVE FORWARD")

    def test_auto_stop_rov(self):
        dock_command = docking_red_center_allign("images\dockingstation720_close.png")
        self.assertEqual(dock_command, "STOP ROV")

    def test_allign_centers(self):
        dock_command = docking_red_center_allign("images\dockingstation720.png")
