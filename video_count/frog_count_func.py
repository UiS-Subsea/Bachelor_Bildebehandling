...
def frogDetectionMain(image, drawImage = False, showImage = False): # Launches the two detection methods
    ...
    # rectangleOverlapFilter(allRectangles)
    if drawImage:
        ...
        for rectangle in rectangles:
            ...
            for index in range(n, len(rectangles)):
                ...
                if x + w < x2 or x2 + w2 < x:
                    ...
                    #removed.append(rectangles.pop(index))
                    intersects += 1
                    break
    return intersects
